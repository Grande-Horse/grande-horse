...
import StaminaIcon from '@/assets/icons/staminaIcon.svg?react';
  ...
  const horseStats = [
    ...
    return (
      <div
        className={`${selectedIndex !== -1 ? 'visible' : 'invisible'}  mr-4 my-8 bg-background  flex w-full flex-row rounded-sm shadow-[0px_10px_5px_0px_rgba(0,_0,_0,_0.2)] after: bg-[url("src/assets/images/fence.png)] `}
      >
